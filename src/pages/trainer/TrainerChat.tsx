    ...
    >
      <div className="sticky top-0 z-10 bg-tertiary">
        <div className="flex items-center gap-5 p-3">
          <div>
            {conversationData.user_profile ? (
              <img
                className="h-16 w-16 rounded-full"
                src={conversationData.user_profile}
                alt=""
              />
            ) : (
              <img
          ...
          <div className="font-Sans text-2xl">{conversationData.user}</div>
        </div>
        <hr />
      </div>
