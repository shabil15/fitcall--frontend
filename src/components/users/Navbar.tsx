...
export default function Navbar() {
  ...
  return (
    <div className={`fixed top-0 w-full z-20 transition-transform duration-300 ${visible ? 'translate-y-0' : '-translate-y-full'}`}>
        ...
        <div className="items-center hidden w-full md:flex md:w-auto">
          <ul className="flex flex-col md:flex-row md:space-x-8">
            ...
            <li>
              <Link
                to={"/trainers"}
                className="block py-2 px-3  rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-primary"
              >
                Trainers
              </Link>
            </li>
...
Get started
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center justify-center w-10 h-10 p-2 text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 text-gray-400"
